...
CREATE PROCEDURE data_warehouse_control.PROCESS_DATA_TABLE_CELLPHONES_TEMP()
BEGIN
    ...
    UPDATE data_warehouse_control.file_logs SET status = 'DAILY_LOADING' where file_config_id = 1 and date = @date;
    ...
    UPDATE data_warehouse_control.file_logs SET status = 'DAILY_SUCCESS' where file_config_id = 1 and date = @date;
