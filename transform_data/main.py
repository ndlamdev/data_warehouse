...
def transform_data(ids=None, date=datetime.now()):
    # 1. Đọc file_config_id, status và procedure_load_data_warehouse theo ngày
    ...
    for row in range(config_and_logs.shape[0]):
        ...
        # 3. log is None or log != "STAGING_DONE"
        ...
        except Exception as e:  # 4.2. Lỗi hay
            # 4.3 Cập nhật lại log thành trạng thái cũ
